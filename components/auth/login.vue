    ...
    <div class="login">
        <div class="part-1" v-if="step==1">
            <div class="email-sec" v-if="signIn=='email'">
             ...
             <div class="centered-main">
               <div class="email-input">
                   <img src="../../assets/image/letter-icon.svg" alt="letter" class="letter">
            ...
            <div class="phone-sec" v-if="signIn=='phone'">
                ...
                <p>To sign in the the platform, please, enter your number and password.</p>
                <div class="centered-main">
                  <div class="number-input">
                      <img src="../../assets/image/phone-icon.svg" alt="phone" class="phone">
                      <input class="number" v-model="form.email" placeholder="Your number">
                  </div>
                  <div class="pass-input">
                   <img src="../../assets/image/lock.svg" alt="lock icon" class="lock">
               ...
               <a href="#" class="forgot">Forgot password?</a>
                  ...
                  <a href="#"><img src="../../assets/image/right-arrow.svg" alt="left arrow" class="arrow">Other sign up option</a>
                </div>
           </div>
         </div>
    </div>
